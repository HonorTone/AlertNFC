...
ASFLAGS_CC=  
LDFLAGS_NOOVERLAP=  -Map AlertNFC_W013.map -N -T AlertNFC_W013_gnu17IDE.lds -c17-overlap-noerr -c17-memoryover-noerr
LDFLAGS=  -Map AlertNFC_W013.map -N -T AlertNFC_W013_gnu17IDE.lds 
...
$(TARGET).elf : $(OBJS) AlertNFC_W013_gnu17IDE.mak AlertNFC_W013_gnu17IDE.lds
ifeq ($(PASS), 1pass)
# 1pass linking
