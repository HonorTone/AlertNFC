...
CFLAGS= -B$(TOOL_DIR)/ -mshort-offset -gstabs -S   -O1 -I$(TOOL_DIR)/include -Iinc -Iinc/reg -DMCUSEL_C17W13 -fno-builtin -Wall -Werror-implicit-function-declaration  
ASFLAGS= -B$(TOOL_DIR)/ -c -xassembler-with-cpp -Wa,--gstabs  
ASFLAGS_CC=  
LDFLAGS_NOOVERLAP=  -Map AlertNFC_W013_RFC.map -N -T AlertNFC_W013_RFC_gnu17IDE.lds -c17-overlap-noerr -c17-memoryover-noerr
LDFLAGS=  -Map AlertNFC_W013_RFC.map -N -T AlertNFC_W013_RFC_gnu17IDE.lds 
...
$(TARGET).elf : $(OBJS) AlertNFC_W013_RFC_gnu17IDE.mak AlertNFC_W013_RFC_gnu17IDE.lds
ifeq ($(PASS), 1pass)
# 1pass linking
...
## src/I2C.c
src/I2C.o : src/I2C.c src/I2C.ext0
	$(CC) $(CFLAGS) -o $(@:%.o=%.ext0) $<
...
## src/lcd.c
src/lcd.o : src/lcd.c src/lcd.ext0
	$(CC) $(CFLAGS) -o $(@:%.o=%.ext0) $<
	$(AS_CC) $(ASFLAGS_CC) -o $@ $(@:%.o=%.ext0) 
	$(DEPCMD_CC)

## src/lcd4a.c
src/lcd4a.o : src/lcd4a.c src/lcd4a.ext0
	$(CC) $(CFLAGS) -o $(@:%.o=%.ext0) $<
	$(AS_CC) $(ASFLAGS_CC) -o $@ $(@:%.o=%.ext0) 
	$(DEPCMD_CC)
...
src/lcd.ext0 : src/lcd.c
src/lcd4a.ext0 : src/lcd4a.c
