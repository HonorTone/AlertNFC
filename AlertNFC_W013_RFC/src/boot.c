...
func *const vector[] = {			// No	Base+	Name
	...
	VECTOR( emu_copro_process ),	// 3	0C		Co-processor emulation
	...
	VECTOR( intReserved ),			// 10	28		UART2 ch.0 interrupt
	...
	VECTOR( intReserved ),			// 16	40		UART2 ch.1 interrupt
	VECTOR( intReserved ),			// 17	44		T16 ch.2 interrupt
	VECTOR( intReserved ),			// 18	48		SNDA interrupt
	VECTOR( intReserved ),			// 19	4C		LCD4A interrupt
	VECTOR( intReserved ),			// 20	50		RFC ch.0 interrupt
	VECTOR( intReserved ),			// 21	54		REMC2 interrupt
	VECTOR( intReserved ),			// 22	58		reserved
	VECTOR( intReserved ),			// 23	5C		reserved
	VECTOR( intReserved ),			// 24	60		reserved
	VECTOR( intReserved ),			// 25	64		reserved
	VECTOR( intReserved ),			// 26	68		reserved
