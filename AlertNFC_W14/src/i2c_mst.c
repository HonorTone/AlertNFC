...
#define I2C_MST_WAIT_SEND			( 0x4000 )			///< Transmission time-out time.
#define I2C_MST_WAIT_RECEIVE		( 0x4000 )			///< Reception time-out time.
...
int initI2cMst( void )
{
	...
	P1IOEN_P14IEN		= 0;			/// - Set the P1IOEN.P1IEN0 bit to 0(Disable input).
	P1IOEN_P14OEN		= 0;			/// - Set the P1IOEN.P1OEN0 bit to 0(Disable output).
	P1IOEN_P15IEN		= 0;			/// - Set the P1IOEN.P1IEN1 bit to 0(Disable input).
	P1IOEN_P15OEN		= 0;			/// - Set the P1IOEN.P1OEN1 bit to 0(Disable output).

	/// Initialize the I2C input/output function to the ports.
	P1MODSEL_P14SEL		= 0;			/// - P10 : Disable peripheral I/O function.
	P1MODSEL_P15SEL		= 0;			/// - P11 : Disable peripheral I/O function.

	/// Set Universal Port Multiplexer (UPMUX).
	P1UPMUX2_P14PERISEL	= 1;			/// - P10 : I2C.
	P1UPMUX2_P14PPFNC	= 1;			/// - P10 : SCL.
	P1UPMUX2_P14PERICH	= 0;			/// - P10 : Ch.0.
	P1UPMUX2_P15PERISEL	= 1;			/// - P11 : I2C.
	P1UPMUX2_P15PPFNC	= 2;			/// - P11 : SDA.
	P1UPMUX2_P15PERICH	= 0;			/// - P11 : Ch.0.



	/// Assign the I2C input/output function to the ports.
	P1FNCSEL_P14MUX		= 1;			/// - P10 : UPMUX.
	P1FNCSEL_P15MUX		= 1;			/// - P11 : UPMUX.
	P1MODSEL_P14SEL		= 1;			/// - P10 : Enable peripheral I/O function.
	P1MODSEL_P15SEL		= 1;			/// - P11 : Enable peripheral I/O function.
...
int SHTW2ReadData(unsigned char *revData,char len)
{
	...
	status = sendI2cMstData( ADDRES_SHTW2, comm, 2 );
 ...
 ***************************************************************************/
int sendI2cMstData( unsigned char address, unsigned char *data, int size )
{
	int i;
