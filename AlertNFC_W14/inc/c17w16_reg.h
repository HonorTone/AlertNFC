 ...
 *
 * @file	c17w16_reg.h
 * @brief	The definition of S1C17W16's register.
 *
 * @par		Copyright:
 ...
 *
 ************************************************************************* */
#ifndef	C17W16_REG_H__
#define	C17W16_REG_H__
...
#include "./reg/adc12a_reg.h"


// S1C17W16 mode.
#define	SNDA_WAIT_EMIF_CLEARED																			///< Wait until EMIF is cleared.
#define	PWG2_ENABLE																						///< PWG2 Enable.
#define	CLG_OSC3_ENABLE																					///< OSC3 Enable.
#define	LCDX_DISCHARGE_VC																				///< LCD8B Discharge VC.
...
#define	SPIA_1_REG_BASE_ADDR	( 0x5270 )																///< Synchronous Serial Interface (SPIA) Ch.1 Register Base Address.
#define	T16_3_REG_BASE_ADDR		( 0x5280 )																///< 16-bit Timer (T16) Ch.3 Register Base Address.
#define	SPIA_2_REG_BASE_ADDR	( 0x5290 )																///< Synchronous Serial Interface (SPIA) Ch.2 Register Base Address.
...
#define	T16_4_REG_BASE_ADDR		( 0x5480 )																///< 16-bit Timer (T16) Ch.4 Register Base Address.
#define ADC12A_0_REG_BASE_ADDR	( 0x54A2 )																///< A/D converter (ADC12A) Ch.0 Register Base Address.
...
#define	ITCLV3_ILV6			(*((volatile ITCLVX_REG *)(ITC_REG_BASE_ADDR + 0x06))).byte_reg[0]			///< UART Ch.0 interrupt.
...
#define	ITCLV6_ILV12		(*((volatile ITCLVX_REG *)(ITC_REG_BASE_ADDR + 0x0C))).byte_reg[0]			///< UART Ch.1 interrupt.
#define	ITCLV6_ILV13		(*((volatile ITCLVX_REG *)(ITC_REG_BASE_ADDR + 0x0C))).byte_reg[1]			///< Sound generator interrupt.

// ITC Interrupt Level Setup Register 7
#define	ITCLV7				(*((volatile ITCLVX_REG *)(ITC_REG_BASE_ADDR + 0x0E))).reg
#define	ITCLV7_ILV14		(*((volatile ITCLVX_REG *)(ITC_REG_BASE_ADDR + 0x0E))).byte_reg[0]			///< IR remote controller interrupt
...
#define	ITCLV8_ILV17		(*((volatile ITCLVX_REG *)(ITC_REG_BASE_ADDR + 0x10))).byte_reg[1]			///< R/F converter Ch.1 interrupt.

// ITC Interrupt Level Setup Register 9
#define	ITCLV9				(*((volatile ITCLVX_REG *)(ITC_REG_BASE_ADDR + 0x12))).reg
#define	ITCLV9_ILV18		(*((volatile ITCLVX_REG *)(ITC_REG_BASE_ADDR + 0x12))).byte_reg[0]			///< 16-bit timer Ch.2 interrupt.
#define	ITCLV9_ILV19		(*((volatile ITCLVX_REG *)(ITC_REG_BASE_ADDR + 0x12))).byte_reg[1]			///< Synchronous serial interface Ch.1 interrupt.

// ITC Interrupt Level Setup Register 10
#define	ITCLV10				(*((volatile ITCLVX_REG *)(ITC_REG_BASE_ADDR + 0x14))).reg
#define	ITCLV10_ILV20		(*((volatile ITCLVX_REG *)(ITC_REG_BASE_ADDR + 0x14))).byte_reg[0]			///< 16-bit timer Ch.3 interrupt.
#define	ITCLV10_ILV21		(*((volatile ITCLVX_REG *)(ITC_REG_BASE_ADDR + 0x14))).byte_reg[1]			///< 12-bit A/D converter Ch.0 interrupt.

// ITC Interrupt Level Setup Register 11
#define	ITCLV11				(*((volatile ITCLVX_REG *)(ITC_REG_BASE_ADDR + 0x16))).reg
#define	ITCLV11_ILV22		(*((volatile ITCLVX_REG *)(ITC_REG_BASE_ADDR + 0x16))).byte_reg[0]			///< 16-bit timer Ch.4 interrupt.
#define	ITCLV11_ILV23		(*((volatile ITCLVX_REG *)(ITC_REG_BASE_ADDR + 0x16))).byte_reg[1]			///< Synchronous serial interface Ch.2 interrupt.
...
#define	ILVSNDA_0			( ITCLV6_ILV13 )															///< Sound generator interrupt.
#define	ILVREMC2_0			( ITCLV7_ILV14 )															///< IR remote controller interrupt
...
#define	ILVT16_2			( ITCLV9_ILV18 )															///< 16-bit timer Ch.2 interrupt.
#define	ILVSPIA_1			( ITCLV9_ILV19 )															///< Synchronous serial interface Ch.1 interrupt.
#define	ILVT16_3			( ITCLV10_ILV20 )															///< 16-bit timer Ch.3 interrupt.
#define	 ILVADC12_0			( ITCLV10_ILV21 )															///< 12-bit A/D converter Ch.0 interrupt level.
#define	ILVT16_4			( ITCLV11_ILV22 )															///< 16-bit timer Ch.4 interrupt.
#define	ILVSPIA_2			( ITCLV11_ILV23 )															///< Synchronous serial interface Ch.2 interrupt.
...
#define	WDTCLK				(*((volatile WDTCLK_REG *)(WDT_REG_BASE_ADDR + 0x00))).reg
#define	WDTCLK_CLKSRC		(*((volatile WDTCLK_REG *)(WDT_REG_BASE_ADDR + 0x00))).bit.CLKSRC			///< These bits select the clock source of WDT.
#define	WDTCLK_CLKDIV		(*((volatile WDTCLK_REG *)(WDT_REG_BASE_ADDR + 0x00))).bit.CLKDIV			///< These bits select the division ratio of the WDT operating clock (counter clock).
#define	WDTCLK_DBRUN		(*((volatile WDTCLK_REG *)(WDT_REG_BASE_ADDR + 0x00))).byte_reg[1]			///< This bit sets whether the WDT operating clock is supplied in DEBUG mode or not.

// WDT Control Register
#define	WDTCTL				(*((volatile WDTCTL_REG *)(WDT_REG_BASE_ADDR + 0x02))).reg
#define	WDTCTL_WDTRUN		(*((volatile WDTCTL_REG *)(WDT_REG_BASE_ADDR + 0x02))).bit.WDTRUN			///< These bits control WDT to run and stop.
#define	WDTCTL_WDTCNTRST	(*((volatile WDTCTL_REG *)(WDT_REG_BASE_ADDR + 0x02))).bit.WDTCNTRST		///< This bit resets WDT.
...
#define	T16_3CLK			(*((volatile T16_NCLK_REG *)(T16_3_REG_BASE_ADDR + 0x00))).reg
#define	T16_3CLK_CLKSRC		(*((volatile T16_NCLK_REG *)(T16_3_REG_BASE_ADDR + 0x00))).bit.CLKSRC		///< These bits select the clock source of T16 Ch.3.
#define	T16_3CLK_CLKDIV		(*((volatile T16_NCLK_REG *)(T16_3_REG_BASE_ADDR + 0x00))).bit.CLKDIV		///< These bits select the division ratio of the T16 Ch.3 operating clock (counter clock).
#define	T16_3CLK_DBRUN		(*((volatile T16_NCLK_REG *)(T16_3_REG_BASE_ADDR + 0x00))).byte_reg[1]		///< This bit sets whether the T16 Ch.3 operating clock is supplied in DEBUG mode or not.

// T16 Ch.3 Mode Register
#define	T16_3MOD			(*((volatile T16_NMOD_REG *)(T16_3_REG_BASE_ADDR + 0x02))).reg
#define	T16_3MOD_TRMD		T16_3MOD																	///< This bit selects the T16(Ch.3) operation mode.

// T16 Ch.3 Control Register
#define	T16_3CTL			(*((volatile T16_NCTL_REG *)(T16_3_REG_BASE_ADDR + 0x04))).reg
#define	T16_3CTL_MODEN		(*((volatile T16_NCTL_REG *)(T16_3_REG_BASE_ADDR + 0x04))).bit.MODEN		///< This bit enables the T16 operations(Ch.3).
#define	T16_3CTL_PRESET		(*((volatile T16_NCTL_REG *)(T16_3_REG_BASE_ADDR + 0x04))).bit.PRESET		///< This bit presets the reload data stored in the T16_3TR register to the counter.
#define	T16_3CTL_PRUN		(*((volatile T16_NCTL_REG *)(T16_3_REG_BASE_ADDR + 0x04))).byte_reg[1]		///< This bit starts/stops the timer(Ch.3).

// T16 Ch.3 Reload Data Register
#define	T16_3TR				(*((volatile T16_NTR_REG *)(T16_3_REG_BASE_ADDR + 0x06))).reg

// T16 Ch.3 Counter Data Register
#define	T16_3TC				(*((volatile T16_NTC_REG *)(T16_3_REG_BASE_ADDR + 0x08))).reg

// T16 Ch.3 Interrupt Flag Register
#define	T16_3INTF			(*((volatile T16_NINTF_REG *)(T16_3_REG_BASE_ADDR + 0x0A))).reg
#define	T16_3INTF_UFIF		T16_3INTF																	///< This bit indicates the T16 Ch.3 underflow interrupt cause occurrence status.

// T16 Ch.3 Interrupt Enable Register
#define	T16_3INTE			(*((volatile T16_NINTE_REG *)(T16_3_REG_BASE_ADDR + 0x0C))).reg
#define	T16_3INTE_UFIE		T16_3INTE																	///< This bit enables T16 Ch.3 underflow interrupts.

// T16 Ch.4 Clock Control Register
#define	T16_4CLK			(*((volatile T16_NCLK_REG *)(T16_4_REG_BASE_ADDR + 0x00))).reg
#define	T16_4CLK_CLKSRC		(*((volatile T16_NCLK_REG *)(T16_4_REG_BASE_ADDR + 0x00))).bit.CLKSRC		///< These bits select the clock source of T16 Ch.4.
#define	T16_4CLK_CLKDIV		(*((volatile T16_NCLK_REG *)(T16_4_REG_BASE_ADDR + 0x00))).bit.CLKDIV		///< These bits select the division ratio of the T16 Ch.4 operating clock (counter clock).
#define	T16_4CLK_DBRUN		(*((volatile T16_NCLK_REG *)(T16_4_REG_BASE_ADDR + 0x00))).byte_reg[1]		///< This bit sets whether the T16 Ch.4 operating clock is supplied in DEBUG mode or not.

// T16 Ch.4 Mode Register
#define	T16_4MOD			(*((volatile T16_NMOD_REG *)(T16_4_REG_BASE_ADDR + 0x02))).reg
#define	T16_4MOD_TRMD		T16_4MOD																	///< This bit selects the T16(Ch.4) operation mode.

// T16 Ch.4 Control Register
#define	T16_4CTL			(*((volatile T16_NCTL_REG *)(T16_4_REG_BASE_ADDR + 0x04))).reg
#define	T16_4CTL_MODEN		(*((volatile T16_NCTL_REG *)(T16_4_REG_BASE_ADDR + 0x04))).bit.MODEN		///< This bit enables the T16 operations(Ch.4).
#define	T16_4CTL_PRESET		(*((volatile T16_NCTL_REG *)(T16_4_REG_BASE_ADDR + 0x04))).bit.PRESET		///< This bit presets the reload data stored in the T16_1TR register to the counter.
#define	T16_4CTL_PRUN		(*((volatile T16_NCTL_REG *)(T16_4_REG_BASE_ADDR + 0x04))).byte_reg[1]		///< This bit starts/stops the timer(Ch.4).

// T16 Ch.4 Reload Data Register
#define	T16_4TR				(*((volatile T16_NTR_REG *)(T16_4_REG_BASE_ADDR + 0x06))).reg

// T16 Ch.4 Counter Data Register
#define	T16_4TC				(*((volatile T16_NTC_REG *)(T16_4_REG_BASE_ADDR + 0x08))).reg

// T16 Ch.4 Interrupt Flag Register
#define	T16_4INTF			(*((volatile T16_NINTF_REG *)(T16_4_REG_BASE_ADDR + 0x0A))).reg
#define	T16_4INTF_UFIF		T16_4INTF																	///< This bit indicates the T16 Ch.4 underflow interrupt cause occurrence status.

// T16 Ch.4 Interrupt Enable Register
#define	T16_4INTE			(*((volatile T16_NINTE_REG *)(T16_4_REG_BASE_ADDR + 0x0C))).reg
#define	T16_4INTE_UFIE		T16_4INTE																	///< This bit enables T16 Ch.4 underflow interrupts.
...
#define	FLASHCWAIT_RDWAIT	(*((volatile FLASHCWAIT_REG *)(FLASHC_REG_BASE_ADDR + 0x00))).bit.RDWAIT	///< These bits set the number of bus access cycles for reading from the Flash memory.
#define	FLASHCWAIT_XBUSY	(*((volatile FLASHCWAIT_REG *)(FLASHC_REG_BASE_ADDR + 0x00))).bit.XBUSY		///< This bit indicates whether the Flash memory can be accessed or not.
...
#define	P3DAT_P30IN			(*((volatile PXDAT_REG *)(PPORT_REG_BASE_ADDR + 0x30))).bit.Px0IN			///< The GPIO port pin status can be read out from this bit.
#define	P3DAT_P31IN			(*((volatile PXDAT_REG *)(PPORT_REG_BASE_ADDR + 0x30))).bit.Px1IN			///< The GPIO port pin status can be read out from this bit.
#define	P3DAT_P32IN			(*((volatile PXDAT_REG *)(PPORT_REG_BASE_ADDR + 0x30))).bit.Px2IN			///< The GPIO port pin status can be read out from this bit.
#define	P3DAT_P33IN			(*((volatile PXDAT_REG *)(PPORT_REG_BASE_ADDR + 0x30))).bit.Px3IN			///< The GPIO port pin status can be read out from this bit.
#define	P3DAT_P34IN			(*((volatile PXDAT_REG *)(PPORT_REG_BASE_ADDR + 0x30))).bit.Px4IN			///< The GPIO port pin status can be read out from this bit.
#define	P3DAT_P35IN			(*((volatile PXDAT_REG *)(PPORT_REG_BASE_ADDR + 0x30))).bit.Px5IN			///< The GPIO port pin status can be read out from this bit.
#define	P3DAT_P36IN			(*((volatile PXDAT_REG *)(PPORT_REG_BASE_ADDR + 0x30))).bit.Px6IN			///< The GPIO port pin status can be read out from this bit.
#define	P3DAT_P37IN			(*((volatile PXDAT_REG *)(PPORT_REG_BASE_ADDR + 0x30))).bit.Px7IN			///< The GPIO port pin status can be read out from this bit.
...
#define	P3DAT_P32OUT		(*((volatile PXDAT_REG *)(PPORT_REG_BASE_ADDR + 0x30))).bit.Px2OUT			///< This bit are used to set data to be output from the GPIO port pin.
#define	P3DAT_P33OUT		(*((volatile PXDAT_REG *)(PPORT_REG_BASE_ADDR + 0x30))).bit.Px3OUT			///< This bit are used to set data to be output from the GPIO port pin.
#define	P3DAT_P34OUT		(*((volatile PXDAT_REG *)(PPORT_REG_BASE_ADDR + 0x30))).bit.Px4OUT			///< This bit are used to set data to be output from the GPIO port pin.
#define	P3DAT_P35OUT		(*((volatile PXDAT_REG *)(PPORT_REG_BASE_ADDR + 0x30))).bit.Px5OUT			///< This bit are used to set data to be output from the GPIO port pin.
#define	P3DAT_P36OUT		(*((volatile PXDAT_REG *)(PPORT_REG_BASE_ADDR + 0x30))).bit.Px6OUT			///< This bit are used to set data to be output from the GPIO port pin.
#define	P3DAT_P37OUT		(*((volatile PXDAT_REG *)(PPORT_REG_BASE_ADDR + 0x30))).bit.Px7OUT			///< This bit are used to set data to be output from the GPIO port pin.

#define	P3DAT_P3IN			(*((volatile PXDAT_REG *)(PPORT_REG_BASE_ADDR + 0x30))).byte_reg[0]			///< The GPIO port pin status can be read out from this bit.
...
#define	P3IOEN_P32OEN		(*((volatile PXIOEN_REG *)(PPORT_REG_BASE_ADDR + 0x32))).bit.Px2OEN			///< This bit enable/disable the GPIO port output.
#define	P3IOEN_P33OEN		(*((volatile PXIOEN_REG *)(PPORT_REG_BASE_ADDR + 0x32))).bit.Px3OEN			///< This bit enable/disable the GPIO port output.
#define	P3IOEN_P34OEN		(*((volatile PXIOEN_REG *)(PPORT_REG_BASE_ADDR + 0x32))).bit.Px4OEN			///< This bit enable/disable the GPIO port output.
#define	P3IOEN_P35OEN		(*((volatile PXIOEN_REG *)(PPORT_REG_BASE_ADDR + 0x32))).bit.Px5OEN			///< This bit enable/disable the GPIO port output.
#define	P3IOEN_P36OEN		(*((volatile PXIOEN_REG *)(PPORT_REG_BASE_ADDR + 0x32))).bit.Px6OEN			///< This bit enable/disable the GPIO port output.
#define	P3IOEN_P37OEN		(*((volatile PXIOEN_REG *)(PPORT_REG_BASE_ADDR + 0x32))).bit.Px7OEN			///< This bit enable/disable the GPIO port output.
#define	P3IOEN_P30IEN		(*((volatile PXIOEN_REG *)(PPORT_REG_BASE_ADDR + 0x32))).bit.Px0IEN			///< This bit enable/disable the GPIO port input.
#define	P3IOEN_P31IEN		(*((volatile PXIOEN_REG *)(PPORT_REG_BASE_ADDR + 0x32))).bit.Px1IEN			///< This bit enable/disable the GPIO port input.
#define	P3IOEN_P32IEN		(*((volatile PXIOEN_REG *)(PPORT_REG_BASE_ADDR + 0x32))).bit.Px2IEN			///< This bit enable/disable the GPIO port input.
#define	P3IOEN_P33IEN		(*((volatile PXIOEN_REG *)(PPORT_REG_BASE_ADDR + 0x32))).bit.Px3IEN			///< This bit enable/disable the GPIO port input.
#define	P3IOEN_P34IEN		(*((volatile PXIOEN_REG *)(PPORT_REG_BASE_ADDR + 0x32))).bit.Px4IEN			///< This bit enable/disable the GPIO port input.
#define	P3IOEN_P35IEN		(*((volatile PXIOEN_REG *)(PPORT_REG_BASE_ADDR + 0x32))).bit.Px5IEN			///< This bit enable/disable the GPIO port input.
#define	P3IOEN_P36IEN		(*((volatile PXIOEN_REG *)(PPORT_REG_BASE_ADDR + 0x32))).bit.Px6IEN			///< This bit enable/disable the GPIO port input.
#define	P3IOEN_P37IEN		(*((volatile PXIOEN_REG *)(PPORT_REG_BASE_ADDR + 0x32))).bit.Px7IEN			///< This bit enable/disable the GPIO port input.

#define	P3IOEN_P3OEN		(*((volatile PXIOEN_REG *)(PPORT_REG_BASE_ADDR + 0x32))).byte_reg[0]		///< This bit enable/disable the GPIO port output.
#define	P3IOEN_P3IEN		(*((volatile PXIOEN_REG *)(PPORT_REG_BASE_ADDR + 0x32))).byte_reg[1]		///< This bit enable/disable the GPIO port input.


// P3 Port Pull-up/down Control Register
#define	P3RCTL				(*((volatile PXRCTL_REG *)(PPORT_REG_BASE_ADDR + 0x34))).reg
#define	P3RCTL_P30REN		(*((volatile PXRCTL_REG *)(PPORT_REG_BASE_ADDR + 0x34))).bit.Px0REN			///< This bit enable/disable the port pull-up/down control.
#define	P3RCTL_P31REN		(*((volatile PXRCTL_REG *)(PPORT_REG_BASE_ADDR + 0x34))).bit.Px1REN			///< This bit enable/disable the port pull-up/down control.
#define	P3RCTL_P32REN		(*((volatile PXRCTL_REG *)(PPORT_REG_BASE_ADDR + 0x34))).bit.Px2REN			///< This bit enable/disable the port pull-up/down control.
#define	P3RCTL_P33REN		(*((volatile PXRCTL_REG *)(PPORT_REG_BASE_ADDR + 0x34))).bit.Px3REN			///< This bit enable/disable the port pull-up/down control.
#define	P3RCTL_P34REN		(*((volatile PXRCTL_REG *)(PPORT_REG_BASE_ADDR + 0x34))).bit.Px4REN			///< This bit enable/disable the port pull-up/down control.
#define	P3RCTL_P35REN		(*((volatile PXRCTL_REG *)(PPORT_REG_BASE_ADDR + 0x34))).bit.Px5REN			///< This bit enable/disable the port pull-up/down control.
#define	P3RCTL_P36REN		(*((volatile PXRCTL_REG *)(PPORT_REG_BASE_ADDR + 0x34))).bit.Px6REN			///< This bit enable/disable the port pull-up/down control.
#define	P3RCTL_P37REN		(*((volatile PXRCTL_REG *)(PPORT_REG_BASE_ADDR + 0x34))).bit.Px7REN			///< This bit enable/disable the port pull-up/down control.
#define	P3RCTL_P30PDPU		(*((volatile PXRCTL_REG *)(PPORT_REG_BASE_ADDR + 0x34))).bit.Px0PDPU		///< This bit select either the pull-up resistor or the pull-down resistor when using a resistor built into the port.
#define	P3RCTL_P31PDPU		(*((volatile PXRCTL_REG *)(PPORT_REG_BASE_ADDR + 0x34))).bit.Px1PDPU		///< This bit select either the pull-up resistor or the pull-down resistor when using a resistor built into the port.
#define	P3RCTL_P32PDPU		(*((volatile PXRCTL_REG *)(PPORT_REG_BASE_ADDR + 0x34))).bit.Px2PDPU		///< This bit select either the pull-up resistor or the pull-down resistor when using a resistor built into the port.
#define	P3RCTL_P33PDPU		(*((volatile PXRCTL_REG *)(PPORT_REG_BASE_ADDR + 0x34))).bit.Px3PDPU		///< This bit select either the pull-up resistor or the pull-down resistor when using a resistor built into the port.
#define	P3RCTL_P34PDPU		(*((volatile PXRCTL_REG *)(PPORT_REG_BASE_ADDR + 0x34))).bit.Px4PDPU		///< This bit select either the pull-up resistor or the pull-down resistor when using a resistor built into the port.
#define	P3RCTL_P35PDPU		(*((volatile PXRCTL_REG *)(PPORT_REG_BASE_ADDR + 0x34))).bit.Px5PDPU		///< This bit select either the pull-up resistor or the pull-down resistor when using a resistor built into the port.
#define	P3RCTL_P36PDPU		(*((volatile PXRCTL_REG *)(PPORT_REG_BASE_ADDR + 0x34))).bit.Px6PDPU		///< This bit select either the pull-up resistor or the pull-down resistor when using a resistor built into the port.
#define	P3RCTL_P37PDPU		(*((volatile PXRCTL_REG *)(PPORT_REG_BASE_ADDR + 0x34))).bit.Px7PDPU		///< This bit select either the pull-up resistor or the pull-down resistor when using a resistor built into the port.

#define	P3RCTL_P3REN		(*((volatile PXRCTL_REG *)(PPORT_REG_BASE_ADDR + 0x34))).byte_reg[0]		///< This bit enable/disable the port pull-up/down control.
#define	P3RCTL_P3PDPU		(*((volatile PXRCTL_REG *)(PPORT_REG_BASE_ADDR + 0x34))).byte_reg[1]		///< This bit select either the pull-up resistor or the pull-down resistor when using a resistor built into the port.


// P3 Port Interrupt Flag Register
#define	P3INTF				(*((volatile PXINTF_REG *)(PPORT_REG_BASE_ADDR + 0x36))).reg
#define	P3INTF_P30IF		(*((volatile PXINTF_REG *)(PPORT_REG_BASE_ADDR + 0x36))).bit.Px0IF			///< This bit indicate the port input interrupt cause occurrence status.
#define	P3INTF_P31IF		(*((volatile PXINTF_REG *)(PPORT_REG_BASE_ADDR + 0x36))).bit.Px1IF			///< This bit indicate the port input interrupt cause occurrence status.
#define	P3INTF_P32IF		(*((volatile PXINTF_REG *)(PPORT_REG_BASE_ADDR + 0x36))).bit.Px2IF			///< This bit indicate the port input interrupt cause occurrence status.
#define	P3INTF_P33IF		(*((volatile PXINTF_REG *)(PPORT_REG_BASE_ADDR + 0x36))).bit.Px3IF			///< This bit indicate the port input interrupt cause occurrence status.
#define	P3INTF_P34IF		(*((volatile PXINTF_REG *)(PPORT_REG_BASE_ADDR + 0x36))).bit.Px4IF			///< This bit indicate the port input interrupt cause occurrence status.
#define	P3INTF_P35IF		(*((volatile PXINTF_REG *)(PPORT_REG_BASE_ADDR + 0x36))).bit.Px5IF			///< This bit indicate the port input interrupt cause occurrence status.
#define	P3INTF_P36IF		(*((volatile PXINTF_REG *)(PPORT_REG_BASE_ADDR + 0x36))).bit.Px6IF			///< This bit indicate the port input interrupt cause occurrence status.
#define	P3INTF_P37IF		(*((volatile PXINTF_REG *)(PPORT_REG_BASE_ADDR + 0x36))).bit.Px7IF			///< This bit indicate the port input interrupt cause occurrence status.

#define	P3INTF_P3IF			P3INTF																		///< This bit indicate the port input interrupt cause occurrence status.


// P3 Port Interrupt Control Register
#define	P3INTCTL			(*((volatile PXINTCTL_REG *)(PPORT_REG_BASE_ADDR + 0x38))).reg
#define	P3INTCTL_P30IE		(*((volatile PXINTCTL_REG *)(PPORT_REG_BASE_ADDR + 0x38))).bit.Px0IE		///< This bit enable port input interrupt.
#define	P3INTCTL_P31IE		(*((volatile PXINTCTL_REG *)(PPORT_REG_BASE_ADDR + 0x38))).bit.Px1IE		///< This bit enable port input interrupt.
#define	P3INTCTL_P32IE		(*((volatile PXINTCTL_REG *)(PPORT_REG_BASE_ADDR + 0x38))).bit.Px2IE		///< This bit enable port input interrupt.
#define	P3INTCTL_P33IE		(*((volatile PXINTCTL_REG *)(PPORT_REG_BASE_ADDR + 0x38))).bit.Px3IE		///< This bit enable port input interrupt.
#define	P3INTCTL_P34IE		(*((volatile PXINTCTL_REG *)(PPORT_REG_BASE_ADDR + 0x38))).bit.Px4IE		///< This bit enable port input interrupt.
#define	P3INTCTL_P35IE		(*((volatile PXINTCTL_REG *)(PPORT_REG_BASE_ADDR + 0x38))).bit.Px5IE		///< This bit enable port input interrupt.
#define	P3INTCTL_P36IE		(*((volatile PXINTCTL_REG *)(PPORT_REG_BASE_ADDR + 0x38))).bit.Px6IE		///< This bit enable port input interrupt.
#define	P3INTCTL_P37IE		(*((volatile PXINTCTL_REG *)(PPORT_REG_BASE_ADDR + 0x38))).bit.Px7IE		///< This bit enable port input interrupt.
#define	P3INTCTL_P30EDGE	(*((volatile PXINTCTL_REG *)(PPORT_REG_BASE_ADDR + 0x38))).bit.Px0EDGE		///< This bit select the input signal edge to generate a port input interrupt.
#define	P3INTCTL_P31EDGE	(*((volatile PXINTCTL_REG *)(PPORT_REG_BASE_ADDR + 0x38))).bit.Px1EDGE		///< This bit select the input signal edge to generate a port input interrupt.
#define	P3INTCTL_P32EDGE	(*((volatile PXINTCTL_REG *)(PPORT_REG_BASE_ADDR + 0x38))).bit.Px2EDGE		///< This bit select the input signal edge to generate a port input interrupt.
#define	P3INTCTL_P33EDGE	(*((volatile PXINTCTL_REG *)(PPORT_REG_BASE_ADDR + 0x38))).bit.Px3EDGE		///< This bit select the input signal edge to generate a port input interrupt.
#define	P3INTCTL_P34EDGE	(*((volatile PXINTCTL_REG *)(PPORT_REG_BASE_ADDR + 0x38))).bit.Px4EDGE		///< This bit select the input signal edge to generate a port input interrupt.
#define	P3INTCTL_P35EDGE	(*((volatile PXINTCTL_REG *)(PPORT_REG_BASE_ADDR + 0x38))).bit.Px5EDGE		///< This bit select the input signal edge to generate a port input interrupt.
#define	P3INTCTL_P36EDGE	(*((volatile PXINTCTL_REG *)(PPORT_REG_BASE_ADDR + 0x38))).bit.Px6EDGE		///< This bit select the input signal edge to generate a port input interrupt.
#define	P3INTCTL_P37EDGE	(*((volatile PXINTCTL_REG *)(PPORT_REG_BASE_ADDR + 0x38))).bit.Px7EDGE		///< This bit select the input signal edge to generate a port input interrupt.

#define	P3INTCTL_P3IE		(*((volatile PXINTCTL_REG *)(PPORT_REG_BASE_ADDR + 0x38))).byte_reg[0]		///< This bit enable port input interrupt.
#define	P3INTCTL_P3EDGE		(*((volatile PXINTCTL_REG *)(PPORT_REG_BASE_ADDR + 0x38))).byte_reg[1]		///< This bit select the input signal edge to generate a port input interrupt.


// P3 Port Chattering Filter Enable Register
#define	P3CHATEN			(*((volatile PXCHATEN_REG *)(PPORT_REG_BASE_ADDR + 0x3A))).reg
#define	P3CHATEN_P30CHATEN	(*((volatile PXCHATEN_REG *)(PPORT_REG_BASE_ADDR + 0x3A))).bit.Px0CHATEN	///< This bit enable/disable the chattering filter function.
#define	P3CHATEN_P31CHATEN	(*((volatile PXCHATEN_REG *)(PPORT_REG_BASE_ADDR + 0x3A))).bit.Px1CHATEN	///< This bit enable/disable the chattering filter function.
#define	P3CHATEN_P32CHATEN	(*((volatile PXCHATEN_REG *)(PPORT_REG_BASE_ADDR + 0x3A))).bit.Px2CHATEN	///< This bit enable/disable the chattering filter function.
#define	P3CHATEN_P33CHATEN	(*((volatile PXCHATEN_REG *)(PPORT_REG_BASE_ADDR + 0x3A))).bit.Px3CHATEN	///< This bit enable/disable the chattering filter function.
#define	P3CHATEN_P34CHATEN	(*((volatile PXCHATEN_REG *)(PPORT_REG_BASE_ADDR + 0x3A))).bit.Px4CHATEN	///< This bit enable/disable the chattering filter function.
#define	P3CHATEN_P35CHATEN	(*((volatile PXCHATEN_REG *)(PPORT_REG_BASE_ADDR + 0x3A))).bit.Px5CHATEN	///< This bit enable/disable the chattering filter function.
#define	P3CHATEN_P36CHATEN	(*((volatile PXCHATEN_REG *)(PPORT_REG_BASE_ADDR + 0x3A))).bit.Px6CHATEN	///< This bit enable/disable the chattering filter function.
#define	P3CHATEN_P37CHATEN	(*((volatile PXCHATEN_REG *)(PPORT_REG_BASE_ADDR + 0x3A))).bit.Px7CHATEN	///< This bit enable/disable the chattering filter function.

#define	P3CHATEN_P3CHATEN	P3CHATEN																	///< This bit enable/disable the chattering filter function.
...
#define	P3MODSEL_P32SEL		(*((volatile PXMODSEL_REG *)(PPORT_REG_BASE_ADDR + 0x3C))).bit.Px2SEL		///< This bit select whether each port is used for the GPIO function or a peripheral I/O function.
#define	P3MODSEL_P33SEL		(*((volatile PXMODSEL_REG *)(PPORT_REG_BASE_ADDR + 0x3C))).bit.Px3SEL		///< This bit select whether each port is used for the GPIO function or a peripheral I/O function.
#define	P3MODSEL_P34SEL		(*((volatile PXMODSEL_REG *)(PPORT_REG_BASE_ADDR + 0x3C))).bit.Px4SEL		///< This bit select whether each port is used for the GPIO function or a peripheral I/O function.
#define	P3MODSEL_P35SEL		(*((volatile PXMODSEL_REG *)(PPORT_REG_BASE_ADDR + 0x3C))).bit.Px5SEL		///< This bit select whether each port is used for the GPIO function or a peripheral I/O function.
#define	P3MODSEL_P36SEL		(*((volatile PXMODSEL_REG *)(PPORT_REG_BASE_ADDR + 0x3C))).bit.Px6SEL		///< This bit select whether each port is used for the GPIO function or a peripheral I/O function.
#define	P3MODSEL_P37SEL		(*((volatile PXMODSEL_REG *)(PPORT_REG_BASE_ADDR + 0x3C))).bit.Px7SEL		///< This bit select whether each port is used for the GPIO function or a peripheral I/O function.
...
#define	P3FNCSEL_P32MUX		(*((volatile PXFNCSEL_REG *)(PPORT_REG_BASE_ADDR + 0x3E))).bit.Px2MUX		///< This bit select the peripheral I/O function to be assigned to each port pin.
#define	P3FNCSEL_P33MUX		(*((volatile PXFNCSEL_REG *)(PPORT_REG_BASE_ADDR + 0x3E))).bit.Px3MUX		///< This bit select the peripheral I/O function to be assigned to each port pin.
#define	P3FNCSEL_P34MUX		(*((volatile PXFNCSEL_REG *)(PPORT_REG_BASE_ADDR + 0x3E))).bit.Px4MUX		///< This bit select the peripheral I/O function to be assigned to each port pin.
#define	P3FNCSEL_P35MUX		(*((volatile PXFNCSEL_REG *)(PPORT_REG_BASE_ADDR + 0x3E))).bit.Px5MUX		///< This bit select the peripheral I/O function to be assigned to each port pin.
#define	P3FNCSEL_P36MUX		(*((volatile PXFNCSEL_REG *)(PPORT_REG_BASE_ADDR + 0x3E))).bit.Px6MUX		///< This bit select the peripheral I/O function to be assigned to each port pin.
#define	P3FNCSEL_P37MUX		(*((volatile PXFNCSEL_REG *)(PPORT_REG_BASE_ADDR + 0x3E))).bit.Px7MUX		///< This bit select the peripheral I/O function to be assigned to each port pin.
...
#define	P4DAT_P44IN			(*((volatile PXDAT_REG *)(PPORT_REG_BASE_ADDR + 0x40))).bit.Px4IN			///< The GPIO port pin status can be read out from this bit.
...
#define	P4DAT_P44OUT		(*((volatile PXDAT_REG *)(PPORT_REG_BASE_ADDR + 0x40))).bit.Px4OUT			///< This bit are used to set data to be output from the GPIO port pin.
...
#define	P4IOEN_P44OEN		(*((volatile PXIOEN_REG *)(PPORT_REG_BASE_ADDR + 0x42))).bit.Px4OEN			///< This bit enable/disable the GPIO port output.
...
#define	P4IOEN_P44IEN		(*((volatile PXIOEN_REG *)(PPORT_REG_BASE_ADDR + 0x42))).bit.Px4IEN			///< This bit enable/disable the GPIO port input.
...
#define	P4RCTL_P44REN		(*((volatile PXRCTL_REG *)(PPORT_REG_BASE_ADDR + 0x44))).bit.Px4REN			///< This bit enable/disable the port pull-up/down control.
...
#define	P4RCTL_P44PDPU		(*((volatile PXRCTL_REG *)(PPORT_REG_BASE_ADDR + 0x44))).bit.Px4PDPU		///< This bit select either the pull-up resistor or the pull-down resistor when using a resistor built into the port.
...
#define	P4INTF_P44IF		(*((volatile PXINTF_REG *)(PPORT_REG_BASE_ADDR + 0x46))).bit.Px4IF			///< This bit indicate the port input interrupt cause occurrence status.
...
#define	P4INTCTL_P44IE		(*((volatile PXINTCTL_REG *)(PPORT_REG_BASE_ADDR + 0x48))).bit.Px4IE		///< This bit enable port input interrupt.
...
#define	P4INTCTL_P44EDGE	(*((volatile PXINTCTL_REG *)(PPORT_REG_BASE_ADDR + 0x48))).bit.Px4EDGE		///< This bit select the input signal edge to generate a port input interrupt.
...
#define	P4CHATEN_P44CHATEN	(*((volatile PXCHATEN_REG *)(PPORT_REG_BASE_ADDR + 0x4A))).bit.Px4CHATEN	///< This bit enable/disable the chattering filter function.
...
#define	P4MODSEL_P44SEL		(*((volatile PXMODSEL_REG *)(PPORT_REG_BASE_ADDR + 0x4C))).bit.Px4SEL		///< This bit select whether each port is used for the GPIO function or a peripheral I/O function.

#define	P4MODSEL_P4SEL		P4MODSEL																	///< This bit select whether each port is used for the GPIO function or a peripheral I/O function.
...
#define	P4FNCSEL_P44MUX		(*((volatile PXFNCSEL_REG *)(PPORT_REG_BASE_ADDR + 0x4E))).byte_reg[1]		///< This bit select the peripheral I/O function to be assigned to each port pin.
...
#define	PINTFGRP_P3INT		(*((volatile PINTFGRP_REG *)(PPORT_REG_BASE_ADDR + 0xE2))).bit.P3INT		///< This bit indicate that P3 port group includes a port that has generated an interrupt.
...
#define	P3UPMUX0			(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x18))).reg
#define	P3UPMUX0_P30PERISEL	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x18))).bit.PxyPERISEL	///< These bits specify a peripheral circuit.
#define	P3UPMUX0_P30PERICH	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x18))).bit.PxyPERICH	///< These bits specify a peripheral circuit channel number.
#define	P3UPMUX0_P30PPFNC	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x18))).bit.PxyPPFNC		///< These bits specify the peripheral I/O function to be assigned to the port.
#define	P3UPMUX0_P31PERISEL	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x18))).bit.PxzPERISEL	///< These bits specify a peripheral circuit.
#define	P3UPMUX0_P31PERICH	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x18))).bit.PxzPERICH	///< These bits specify a peripheral circuit channel number.
#define	P3UPMUX0_P31PPFNC	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x18))).bit.PxzPPFNC		///< These bits specify the peripheral I/O function to be assigned to the port.

// P32-33 Universal Port Multiplexer Setting Register
#define	P3UPMUX1			(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x1A))).reg
#define	P3UPMUX1_P32PERISEL	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x1A))).bit.PxyPERISEL	///< These bits specify a peripheral circuit.
#define	P3UPMUX1_P32PERICH	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x1A))).bit.PxyPERICH	///< These bits specify a peripheral circuit channel number.
#define	P3UPMUX1_P32PPFNC	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x1A))).bit.PxyPPFNC		///< These bits specify the peripheral I/O function to be assigned to the port.
#define	P3UPMUX1_P33PERISEL	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x1A))).bit.PxzPERISEL	///< These bits specify a peripheral circuit.
#define	P3UPMUX1_P33PERICH	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x1A))).bit.PxzPERICH	///< These bits specify a peripheral circuit channel number.
#define	P3UPMUX1_P33PPFNC	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x1A))).bit.PxzPPFNC		///< These bits specify the peripheral I/O function to be assigned to the port.

// P34-35 Universal Port Multiplexer Setting Register
#define	P3UPMUX2			(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x1C))).reg
#define	P3UPMUX2_P34PERISEL	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x1C))).bit.PxyPERISEL	///< These bits specify a peripheral circuit.
#define	P3UPMUX2_P34PERICH	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x1C))).bit.PxyPERICH	///< These bits specify a peripheral circuit channel number.
#define	P3UPMUX2_P34PPFNC	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x1C))).bit.PxyPPFNC		///< These bits specify the peripheral I/O function to be assigned to the port.
#define	P3UPMUX2_P35PERISEL	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x1C))).bit.PxzPERISEL	///< These bits specify a peripheral circuit.
#define	P3UPMUX2_P35PERICH	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x1C))).bit.PxzPERICH	///< These bits specify a peripheral circuit channel number.
#define	P3UPMUX2_P35PPFNC	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x1C))).bit.PxzPPFNC		///< These bits specify the peripheral I/O function to be assigned to the port.

// P36-37 Universal Port Multiplexer Setting Register
#define	P3UPMUX3			(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x1E))).reg
#define	P3UPMUX3_P36PERISEL	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x1E))).bit.PxyPERISEL	///< These bits specify a peripheral circuit.
#define	P3UPMUX3_P36PERICH	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x1E))).bit.PxyPERICH	///< These bits specify a peripheral circuit channel number.
#define	P3UPMUX3_P36PPFNC	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x1E))).bit.PxyPPFNC		///< These bits specify the peripheral I/O function to be assigned to the port.
#define	P3UPMUX3_P37PERISEL	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x1E))).bit.PxzPERISEL	///< These bits specify a peripheral circuit.
#define	P3UPMUX3_P37PERICH	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x1E))).bit.PxzPERICH	///< These bits specify a peripheral circuit channel number.
#define	P3UPMUX3_P37PPFNC	(*((volatile PXUPMUXN_REG *)(UPMUX_REG_BASE_ADDR + 0x1E))).bit.PxzPPFNC		///< These bits specify the peripheral I/O function to be assigned to the port.
...
#define	UA0CLK				(*((volatile UANCLK_REG *)(UART_0_REG_BASE_ADDR + 0x00))).reg
#define	UA0CLK_CLKSRC		(*((volatile UANCLK_REG *)(UART_0_REG_BASE_ADDR + 0x00))).bit.CLKSRC		///< These bits select the clock source of the UART.
#define	UA0CLK_CLKDIV		(*((volatile UANCLK_REG *)(UART_0_REG_BASE_ADDR + 0x00))).bit.CLKDIV		///< These bits select the division ratio of the UART operating clock.
#define	UA0CLK_DBRUN		(*((volatile UANCLK_REG *)(UART_0_REG_BASE_ADDR + 0x00))).byte_reg[1]		///< This bit sets whether the UART operating clock is supplied in DEBUG mode or not.

// UART Ch.0 Mode Register
#define	UA0MOD				(*((volatile UANMOD_REG *)(UART_0_REG_BASE_ADDR + 0x02))).reg
#define	UA0MOD_STPB			(*((volatile UANMOD_REG *)(UART_0_REG_BASE_ADDR + 0x02))).bit.STPB			///< This bit sets the stop bit length.
#define	UA0MOD_PRMD			(*((volatile UANMOD_REG *)(UART_0_REG_BASE_ADDR + 0x02))).bit.PRMD			///< This bit selects either odd parity or even parity when using the parity function.
#define	UA0MOD_PREN			(*((volatile UANMOD_REG *)(UART_0_REG_BASE_ADDR + 0x02))).bit.PREN			///< This bit sets the data length.
#define	UA0MOD_CHLN			(*((volatile UANMOD_REG *)(UART_0_REG_BASE_ADDR + 0x02))).bit.CHLN			///< This bit sets the data length.
#define	UA0MOD_IRMD			(*((volatile UANMOD_REG *)(UART_0_REG_BASE_ADDR + 0x02))).bit.IRMD			///< This bit enables the IrDA interface function.
#define	UA0MOD_OUTMD		(*((volatile UANMOD_REG *)(UART_0_REG_BASE_ADDR + 0x02))).bit.OUTMD			///< This bit sets the USOUT0 pin output mode.
#define	UA0MOD_PUEN			(*((volatile UANMOD_REG *)(UART_0_REG_BASE_ADDR + 0x02))).bit.PUEN			///< This bit enables pull-up of the USIN0 pin.
#define	UA0MOD_INVIRTX		(*((volatile UANMOD_REG *)(UART_0_REG_BASE_ADDR + 0x02))).bit.INVIRTX		///< This bit enables the USOUT0 output inverting function when the IrDA interface function is enabled.
#define	UA0MOD_INVIRRX		(*((volatile UANMOD_REG *)(UART_0_REG_BASE_ADDR + 0x02))).bit.INVIRRX		///< This bit enables the USIN0 input inverting function when the IrDA interface function is enabled.

// UART Ch.0 Baud-Rate Register
#define	UA0BR				(*((volatile UANBR_REG *)(UART_0_REG_BASE_ADDR + 0x04))).reg
#define	UA0BR_BRT			(*((volatile UANBR_REG *)(UART_0_REG_BASE_ADDR + 0x04))).byte_reg[0]			///< These bits set the UART transfer rate.
#define	UA0BR_FMD			(*((volatile UANBR_REG *)(UART_0_REG_BASE_ADDR + 0x04))).byte_reg[1]		///< These bits set the UART transfer rate.

// UART Ch.0 Control Register
#define	UA0CTL				(*((volatile UANCTL_REG *)(UART_0_REG_BASE_ADDR + 0x06))).reg
#define	UA0CTL_MODEN		(*((volatile UANCTL_REG *)(UART_0_REG_BASE_ADDR + 0x06))).bit.MODEN			///< This bit enables the UART operations.
#define	UA0CTL_SFTRST		(*((volatile UANCTL_REG *)(UART_0_REG_BASE_ADDR + 0x06))).bit.SFTRST		///< This bit issues software reset to the UART.

// UART Ch.0 Transmit Data Register
#define	UA0TXD				(*((volatile UANTXD_REG *)(UART_0_REG_BASE_ADDR + 0x08))).reg
...
#define	UA0RXD				(*((volatile UANRXD_REG *)(UART_0_REG_BASE_ADDR + 0x0A))).reg
...
#define	UA0INTF				(*((volatile UANINTF_REG *)(UART_0_REG_BASE_ADDR + 0x0C))).reg
#define	UA0INTF_TBEIF		(*((volatile UANINTF_REG *)(UART_0_REG_BASE_ADDR + 0x0C))).bit.TBEIF		///< These bits indicate Transmit buffer empty interrupt cause occurrence status.
#define	UA0INTF_RB1FIF		(*((volatile UANINTF_REG *)(UART_0_REG_BASE_ADDR + 0x0C))).bit.RB1FIF		///< These bits indicate Receive buffer one byte full interrupt cause occurrence status.
#define	UA0INTF_RB2FIF		(*((volatile UANINTF_REG *)(UART_0_REG_BASE_ADDR + 0x0C))).bit.RB2FIF		///< These bits indicate Receive buffer two bytes full interrupt cause occurrence status.
#define	UA0INTF_OEIF		(*((volatile UANINTF_REG *)(UART_0_REG_BASE_ADDR + 0x0C))).bit.OEIF			///< These bits indicate Overrun error interrupt cause occurrence status.
#define	UA0INTF_PEIF		(*((volatile UANINTF_REG *)(UART_0_REG_BASE_ADDR + 0x0C))).bit.PEIF			///< These bits indicate Parity error interrupt cause occurrence status.
#define	UA0INTF_FEIF		(*((volatile UANINTF_REG *)(UART_0_REG_BASE_ADDR + 0x0C))).bit.FEIF			///< These bits indicate Framing error interrupt cause occurrence status.
#define	UA0INTF_TENDIF		(*((volatile UANINTF_REG *)(UART_0_REG_BASE_ADDR + 0x0C))).bit.TENDIF		///< These bits indicate End-of-transmission interrupt cause occurrence status.
#define	UA0INTF_TBSY		(*((volatile UANINTF_REG *)(UART_0_REG_BASE_ADDR + 0x0C))).bit.TBSY			///< This bit indicates the sending status.
#define	UA0INTF_RBSY		(*((volatile UANINTF_REG *)(UART_0_REG_BASE_ADDR + 0x0C))).bit.RBSY			///< This bit indicates the receiving status.

// UART Ch.0 Interrupt Enable Register
#define	UA0INTE				(*((volatile UANINTE_REG *)(UART_0_REG_BASE_ADDR + 0x0E))).reg
#define	UA0INTE_TBEIE		(*((volatile UANINTE_REG *)(UART_0_REG_BASE_ADDR + 0x0E))).bit.TBEIE		///< These bits enable Transmit buffer empty interrupt.
#define	UA0INTE_RB1FIE		(*((volatile UANINTE_REG *)(UART_0_REG_BASE_ADDR + 0x0E))).bit.RB1FIE		///< These bits enable Receive buffer one byte full interrupt.
#define	UA0INTE_RB2FIE		(*((volatile UANINTE_REG *)(UART_0_REG_BASE_ADDR + 0x0E))).bit.RB2FIE		///< These bits enable Receive buffer two bytes full interrupt.
#define	UA0INTE_OEIE		(*((volatile UANINTE_REG *)(UART_0_REG_BASE_ADDR + 0x0E))).bit.OEIE			///< These bits enable Overrun error interrupt.
#define	UA0INTE_PEIE		(*((volatile UANINTE_REG *)(UART_0_REG_BASE_ADDR + 0x0E))).bit.PEIE			///< These bits enable Parity error interrupt.
#define	UA0INTE_FEIE		(*((volatile UANINTE_REG *)(UART_0_REG_BASE_ADDR + 0x0E))).bit.FEIE			///< These bits enable Framing error interrupt.
#define	UA0INTE_TENDIE		(*((volatile UANINTE_REG *)(UART_0_REG_BASE_ADDR + 0x0E))).bit.TENDIE		///< These bits enable End-of-transmission interrupt.

// UART Ch.1 Clock Control Register
#define	UA1CLK				(*((volatile UANCLK_REG *)(UART_1_REG_BASE_ADDR + 0x00))).reg
#define	UA1CLK_CLKSRC		(*((volatile UANCLK_REG *)(UART_1_REG_BASE_ADDR + 0x00))).bit.CLKSRC		///< These bits select the clock source of the UART.
#define	UA1CLK_CLKDIV		(*((volatile UANCLK_REG *)(UART_1_REG_BASE_ADDR + 0x00))).bit.CLKDIV		///< These bits select the division ratio of the UART operating clock.
#define	UA1CLK_DBRUN		(*((volatile UANCLK_REG *)(UART_1_REG_BASE_ADDR + 0x00))).byte_reg[1]		///< This bit sets whether the UART operating clock is supplied in DEBUG mode or not.

// UART Ch.1 Mode Register
#define	UA1MOD				(*((volatile UANMOD_REG *)(UART_1_REG_BASE_ADDR + 0x02))).reg
#define	UA1MOD_STPB			(*((volatile UANMOD_REG *)(UART_1_REG_BASE_ADDR + 0x02))).bit.STPB			///< This bit sets the stop bit length.
#define	UA1MOD_PRMD			(*((volatile UANMOD_REG *)(UART_1_REG_BASE_ADDR + 0x02))).bit.PRMD			///< This bit selects either odd parity or even parity when using the parity function.
#define	UA1MOD_PREN			(*((volatile UANMOD_REG *)(UART_1_REG_BASE_ADDR + 0x02))).bit.PREN			///< This bit sets the data length.
#define	UA1MOD_CHLN			(*((volatile UANMOD_REG *)(UART_1_REG_BASE_ADDR + 0x02))).bit.CHLN			///< This bit sets the data length.
#define	UA1MOD_IRMD			(*((volatile UANMOD_REG *)(UART_1_REG_BASE_ADDR + 0x02))).bit.IRMD			///< This bit enables the IrDA interface function.
#define	UA1MOD_OUTMD		(*((volatile UANMOD_REG *)(UART_1_REG_BASE_ADDR + 0x02))).bit.OUTMD			///< This bit sets the USOUT0 pin output mode.
#define	UA1MOD_PUEN			(*((volatile UANMOD_REG *)(UART_1_REG_BASE_ADDR + 0x02))).bit.PUEN			///< This bit enables pull-up of the USIN0 pin.
#define	UA1MOD_INVIRTX		(*((volatile UANMOD_REG *)(UART_1_REG_BASE_ADDR + 0x02))).bit.INVIRTX		///< This bit enables the USOUT0 output inverting function when the IrDA interface function is enabled.
#define	UA1MOD_INVIRRX		(*((volatile UANMOD_REG *)(UART_1_REG_BASE_ADDR + 0x02))).bit.INVIRRX		///< This bit enables the USIN0 input inverting function when the IrDA interface function is enabled.

// UART Ch.1 Baud-Rate Register
#define	UA1BR				(*((volatile UANBR_REG *)(UART_1_REG_BASE_ADDR + 0x04))).reg
#define	UA1BR_BRT			(*((volatile UANBR_REG *)(UART_1_REG_BASE_ADDR + 0x04))).byte_reg[0]			///< These bits set the UART transfer rate.
#define	UA1BR_FMD			(*((volatile UANBR_REG *)(UART_1_REG_BASE_ADDR + 0x04))).byte_reg[1]		///< These bits set the UART transfer rate.

// UART Ch.1 Control Register
#define	UA1CTL				(*((volatile UANCTL_REG *)(UART_1_REG_BASE_ADDR + 0x06))).reg
#define	UA1CTL_MODEN		(*((volatile UANCTL_REG *)(UART_1_REG_BASE_ADDR + 0x06))).bit.MODEN			///< This bit enables the UART operations.
#define	UA1CTL_SFTRST		(*((volatile UANCTL_REG *)(UART_1_REG_BASE_ADDR + 0x06))).bit.SFTRST		///< This bit issues software reset to the UART.

// UART Ch.1 Transmit Data Register
#define	UA1TXD				(*((volatile UANTXD_REG *)(UART_1_REG_BASE_ADDR + 0x08))).reg
...
#define	UA1RXD				(*((volatile UANRXD_REG *)(UART_1_REG_BASE_ADDR + 0x0A))).reg
...
#define	UA1INTF				(*((volatile UANINTF_REG *)(UART_1_REG_BASE_ADDR + 0x0C))).reg
#define	UA1INTF_TBEIF		(*((volatile UANINTF_REG *)(UART_1_REG_BASE_ADDR + 0x0C))).bit.TBEIF		///< These bits indicate Transmit buffer empty interrupt cause occurrence status.
#define	UA1INTF_RB1FIF		(*((volatile UANINTF_REG *)(UART_1_REG_BASE_ADDR + 0x0C))).bit.RB1FIF		///< These bits indicate Receive buffer one byte full interrupt cause occurrence status.
#define	UA1INTF_RB2FIF		(*((volatile UANINTF_REG *)(UART_1_REG_BASE_ADDR + 0x0C))).bit.RB2FIF		///< These bits indicate Receive buffer two bytes full interrupt cause occurrence status.
#define	UA1INTF_OEIF		(*((volatile UANINTF_REG *)(UART_1_REG_BASE_ADDR + 0x0C))).bit.OEIF			///< These bits indicate Overrun error interrupt cause occurrence status.
#define	UA1INTF_PEIF		(*((volatile UANINTF_REG *)(UART_1_REG_BASE_ADDR + 0x0C))).bit.PEIF			///< These bits indicate Parity error interrupt cause occurrence status.
#define	UA1INTF_FEIF		(*((volatile UANINTF_REG *)(UART_1_REG_BASE_ADDR + 0x0C))).bit.FEIF			///< These bits indicate Framing error interrupt cause occurrence status.
#define	UA1INTF_TENDIF		(*((volatile UANINTF_REG *)(UART_1_REG_BASE_ADDR + 0x0C))).bit.TENDIF		///< These bits indicate End-of-transmission interrupt cause occurrence status.
#define	UA1INTF_TBSY		(*((volatile UANINTF_REG *)(UART_1_REG_BASE_ADDR + 0x0C))).bit.TBSY			///< This bit indicates the sending status.
#define	UA1INTF_RBSY		(*((volatile UANINTF_REG *)(UART_1_REG_BASE_ADDR + 0x0C))).bit.RBSY			///< This bit indicates the receiving status.

// UART Ch.1 Interrupt Enable Register
#define	UA1INTE				(*((volatile UANINTE_REG *)(UART_1_REG_BASE_ADDR + 0x0E))).reg
#define	UA1INTE_TBEIE		(*((volatile UANINTE_REG *)(UART_1_REG_BASE_ADDR + 0x0E))).bit.TBEIE		///< These bits enable Transmit buffer empty interrupt.
#define	UA1INTE_RB1FIE		(*((volatile UANINTE_REG *)(UART_1_REG_BASE_ADDR + 0x0E))).bit.RB1FIE		///< These bits enable Receive buffer one byte full interrupt.
#define	UA1INTE_RB2FIE		(*((volatile UANINTE_REG *)(UART_1_REG_BASE_ADDR + 0x0E))).bit.RB2FIE		///< These bits enable Receive buffer two bytes full interrupt.
#define	UA1INTE_OEIE		(*((volatile UANINTE_REG *)(UART_1_REG_BASE_ADDR + 0x0E))).bit.OEIE			///< These bits enable Overrun error interrupt.
#define	UA1INTE_PEIE		(*((volatile UANINTE_REG *)(UART_1_REG_BASE_ADDR + 0x0E))).bit.PEIE			///< These bits enable Parity error interrupt.
#define	UA1INTE_FEIE		(*((volatile UANINTE_REG *)(UART_1_REG_BASE_ADDR + 0x0E))).bit.FEIE			///< These bits enable Framing error interrupt.
#define	UA1INTE_TENDIE		(*((volatile UANINTE_REG *)(UART_1_REG_BASE_ADDR + 0x0E))).bit.TENDIE		///< These bits enable End-of-transmission interrupt.
...
#define	SPI1MOD				(*((volatile SPINMOD_REG *)(SPIA_1_REG_BASE_ADDR + 0x00))).reg
#define	SPI1MOD_MST			(*((volatile SPINMOD_REG *)(SPIA_1_REG_BASE_ADDR + 0x00))).bit.MST			///< This bit sets the SPIA operating mode (master mode or slave mode).
#define	SPI1MOD_CPOL		(*((volatile SPINMOD_REG *)(SPIA_1_REG_BASE_ADDR + 0x00))).bit.CPOL			///< This bit set the SPI clock phase and polarity.
#define	SPI1MOD_CPHA		(*((volatile SPINMOD_REG *)(SPIA_1_REG_BASE_ADDR + 0x00))).bit.CPHA			///< This bit set the SPI clock phase and polarity.
#define	SPI1MOD_LSBFST		(*((volatile SPINMOD_REG *)(SPIA_1_REG_BASE_ADDR + 0x00))).bit.LSBFST		///< This bit configures the data format (input/output permutation).
#define	SPI1MOD_NOCLKDIV	(*((volatile SPINMOD_REG *)(SPIA_1_REG_BASE_ADDR + 0x00))).bit.NOCLKDIV		///< This bit selects SPICLKn in master mode. This setting is ineffective in slave mode.
#define	SPI1MOD_PUEN		(*((volatile SPINMOD_REG *)(SPIA_1_REG_BASE_ADDR + 0x00))).bit.PUEN			///< This bit enables pull-up/down of the input pins.
#define	SPI1MOD_CHLN		(*((volatile SPINMOD_REG *)(SPIA_1_REG_BASE_ADDR + 0x00))).byte_reg[1]		///< These bits set the bit length of transfer data.

// SPIA Ch.1 Control Register
#define	SPI1CTL				(*((volatile SPINCTL_REG *)(SPIA_1_REG_BASE_ADDR + 0x02))).reg
#define	SPI1CTL_MODEN		(*((volatile SPINCTL_REG *)(SPIA_1_REG_BASE_ADDR + 0x02))).bit.MODEN		///< This bit enables the SPIA operations.
#define	SPI1CTL_SFTRST		(*((volatile SPINCTL_REG *)(SPIA_1_REG_BASE_ADDR + 0x02))).bit.SFTRST		///< This bit issues software reset to SPIA.

// SPIA Ch.1 Transmit Data Register
#define	SPI1TXD				(*((volatile SPINTXD_REG *)(SPIA_1_REG_BASE_ADDR + 0x04))).reg
#define	SPI1TXD_TXD			SPI1TXD																		///< Data can be written to the transmit data buffer through these bits.

// SPIA Ch.1 Receive Data Register
#define	SPI1RXD				(*((volatile SPINRXD_REG *)(SPIA_1_REG_BASE_ADDR + 0x06))).reg
#define	SPI1RXD_RXD			SPI1RXD																		///< The receive data buffer can be read through these bits.

// SPIA Ch.1 Interrupt Flag Register
#define	SPI1INTF			(*((volatile SPININTF_REG *)(SPIA_1_REG_BASE_ADDR + 0x08))).reg
#define	SPI1INTF_TBEIF		(*((volatile SPININTF_REG *)(SPIA_1_REG_BASE_ADDR + 0x08))).bit.TBEIF		///< This bit indicate Transmit buffer empty interrupt cause occurrence status.
#define	SPI1INTF_RBFIF		(*((volatile SPININTF_REG *)(SPIA_1_REG_BASE_ADDR + 0x08))).bit.RBFIF		///< This bit indicate Receive buffer full interrupt cause occurrence status.
#define	SPI1INTF_TENDIF		(*((volatile SPININTF_REG *)(SPIA_1_REG_BASE_ADDR + 0x08))).bit.TENDIF		///< This bit indicate End-of-transmission interrupt cause occurrence status.
#define	SPI1INTF_OEIF		(*((volatile SPININTF_REG *)(SPIA_1_REG_BASE_ADDR + 0x08))).bit.OEIF		///< This bit indicate Overrun error interrupt cause occurrence status.
#define	SPI1INTF_BSY		(*((volatile SPININTF_REG *)(SPIA_1_REG_BASE_ADDR + 0x08))).bit.BSY			///< This bit indicates the SPIA operating status.

// SPIA Ch.1 Interrupt Enable Register
#define	SPI1INTE			(*((volatile SPININTE_REG *)(SPIA_1_REG_BASE_ADDR + 0x0A))).reg
#define	SPI1INTE_TBEIE		(*((volatile SPININTE_REG *)(SPIA_1_REG_BASE_ADDR + 0x0A))).bit.TBEIE		///< This bit enable Transmit buffer empty interrupt.
#define	SPI1INTE_RBFIE		(*((volatile SPININTE_REG *)(SPIA_1_REG_BASE_ADDR + 0x0A))).bit.RBFIE		///< This bit enable Receive buffer full interrupt.
#define	SPI1INTE_TENDIE		(*((volatile SPININTE_REG *)(SPIA_1_REG_BASE_ADDR + 0x0A))).bit.TENDIE		///< This bit enable End-of-transmission interrupt.
#define	SPI1INTE_OEIE		(*((volatile SPININTE_REG *)(SPIA_1_REG_BASE_ADDR + 0x0A))).bit.OEIE		///< This bit enable Overrun error interrupt.

// SPIA Ch.2 Mode Register
#define	SPI2MOD				(*((volatile SPINMOD_REG *)(SPIA_2_REG_BASE_ADDR + 0x00))).reg
#define	SPI2MOD_MST			(*((volatile SPINMOD_REG *)(SPIA_2_REG_BASE_ADDR + 0x00))).bit.MST			///< This bit sets the SPIA operating mode (master mode or slave mode).
#define	SPI2MOD_CPOL		(*((volatile SPINMOD_REG *)(SPIA_2_REG_BASE_ADDR + 0x00))).bit.CPOL			///< This bit set the SPI clock phase and polarity.
#define	SPI2MOD_CPHA		(*((volatile SPINMOD_REG *)(SPIA_2_REG_BASE_ADDR + 0x00))).bit.CPHA			///< This bit set the SPI clock phase and polarity.
#define	SPI2MOD_LSBFST		(*((volatile SPINMOD_REG *)(SPIA_2_REG_BASE_ADDR + 0x00))).bit.LSBFST		///< This bit configures the data format (input/output permutation).
#define	SPI2MOD_NOCLKDIV	(*((volatile SPINMOD_REG *)(SPIA_2_REG_BASE_ADDR + 0x00))).bit.NOCLKDIV		///< This bit selects SPICLKn in master mode. This setting is ineffective in slave mode.
#define	SPI2MOD_PUEN		(*((volatile SPINMOD_REG *)(SPIA_2_REG_BASE_ADDR + 0x00))).bit.PUEN			///< This bit enables pull-up/down of the input pins.
#define	SPI2MOD_CHLN		(*((volatile SPINMOD_REG *)(SPIA_2_REG_BASE_ADDR + 0x00))).byte_reg[1]		///< These bits set the bit length of transfer data.

// SPIA Ch.2 Control Register
#define	SPI2CTL				(*((volatile SPINCTL_REG *)(SPIA_2_REG_BASE_ADDR + 0x02))).reg
#define	SPI2CTL_MODEN		(*((volatile SPINCTL_REG *)(SPIA_2_REG_BASE_ADDR + 0x02))).bit.MODEN		///< This bit enables the SPIA operations.
#define	SPI2CTL_SFTRST		(*((volatile SPINCTL_REG *)(SPIA_2_REG_BASE_ADDR + 0x02))).bit.SFTRST		///< This bit issues software reset to SPIA.

// SPIA Ch.2 Transmit Data Register
#define	SPI2TXD				(*((volatile SPINTXD_REG *)(SPIA_2_REG_BASE_ADDR + 0x04))).reg
#define	SPI2TXD_TXD			SPI2TXD																		///< Data can be written to the transmit data buffer through these bits.

// SPIA Ch.2 Receive Data Register
#define	SPI2RXD				(*((volatile SPINRXD_REG *)(SPIA_2_REG_BASE_ADDR + 0x06))).reg
#define	SPI2RXD_RXD			SPI2RXD																		///< The receive data buffer can be read through these bits.

// SPIA Ch.2 Interrupt Flag Register
#define	SPI2INTF			(*((volatile SPININTF_REG *)(SPIA_2_REG_BASE_ADDR + 0x08))).reg
#define	SPI2INTF_TBEIF		(*((volatile SPININTF_REG *)(SPIA_2_REG_BASE_ADDR + 0x08))).bit.TBEIF		///< This bit indicate Transmit buffer empty interrupt cause occurrence status.
#define	SPI2INTF_RBFIF		(*((volatile SPININTF_REG *)(SPIA_2_REG_BASE_ADDR + 0x08))).bit.RBFIF		///< This bit indicate Receive buffer full interrupt cause occurrence status.
#define	SPI2INTF_TENDIF		(*((volatile SPININTF_REG *)(SPIA_2_REG_BASE_ADDR + 0x08))).bit.TENDIF		///< This bit indicate End-of-transmission interrupt cause occurrence status.
#define	SPI2INTF_OEIF		(*((volatile SPININTF_REG *)(SPIA_2_REG_BASE_ADDR + 0x08))).bit.OEIF		///< This bit indicate Overrun error interrupt cause occurrence status.
#define	SPI2INTF_BSY		(*((volatile SPININTF_REG *)(SPIA_2_REG_BASE_ADDR + 0x08))).bit.BSY			///< This bit indicates the SPIA operating status.

// SPIA Ch.2 Interrupt Enable Register
#define	SPI2INTE			(*((volatile SPININTE_REG *)(SPIA_2_REG_BASE_ADDR + 0x0A))).reg
#define	SPI2INTE_TBEIE		(*((volatile SPININTE_REG *)(SPIA_2_REG_BASE_ADDR + 0x0A))).bit.TBEIE		///< This bit enable Transmit buffer empty interrupt.
#define	SPI2INTE_RBFIE		(*((volatile SPININTE_REG *)(SPIA_2_REG_BASE_ADDR + 0x0A))).bit.RBFIE		///< This bit enable Receive buffer full interrupt.
#define	SPI2INTE_TENDIE		(*((volatile SPININTE_REG *)(SPIA_2_REG_BASE_ADDR + 0x0A))).bit.TENDIE		///< This bit enable End-of-transmission interrupt.
#define	SPI2INTE_OEIE		(*((volatile SPININTE_REG *)(SPIA_2_REG_BASE_ADDR + 0x0A))).bit.OEIE		///< This bit enable Overrun error interrupt.
...
#define	LCD8CLK				(*((volatile LCD8CLK_REG *)(LCD8B_REG_BASE_ADDR + 0x00))).reg
#define	LCD8CLK_CLKSRC		(*((volatile LCD8CLK_REG *)(LCD8B_REG_BASE_ADDR + 0x00))).bit.CLKSRC		///< These bits select the clock source of the LCD8B.
#define	LCD8CLK_CLKDIV		(*((volatile LCD8CLK_REG *)(LCD8B_REG_BASE_ADDR + 0x00))).bit.CLKDIV		///< These bits select the division ratio of the LCD8B operating clock.
#define	LCD8CLK_DBRUN		(*((volatile LCD8CLK_REG *)(LCD8B_REG_BASE_ADDR + 0x00))).byte_reg[1]		///< This bit sets whether the LCD8B operating clock is supplied in DEBUG mode or not.

// LCD8B Control Register
#define	LCD8CTL				(*((volatile LCD8CTL_REG *)(LCD8B_REG_BASE_ADDR + 0x02))).reg
#define	LCD8CTL_MODEN		(*((volatile LCD8CTL_REG *)(LCD8B_REG_BASE_ADDR + 0x02))).bit.MODEN			///< This bit enables the LCD8B operations.
#define	LCD8CTL_LCDDIS		(*((volatile LCD8CTL_REG *)(LCD8B_REG_BASE_ADDR + 0x02))).bit.LCDDIS		///< This bit enables the discharge operations.

// LCD8B Timing Control Register 1
#define	LCD8TIM1			(*((volatile LCD8TIM1_REG *)(LCD8B_REG_BASE_ADDR + 0x04))).reg
#define	LCD8TIM1_LDUTY		(*((volatile LCD8TIM1_REG *)(LCD8B_REG_BASE_ADDR + 0x04))).byte_reg[0]		///< These bits set the drive duty.
#define	LCD8TIM1_FRMCNT		(*((volatile LCD8TIM1_REG *)(LCD8B_REG_BASE_ADDR + 0x04))).byte_reg[1]		///< These bits set the frame frequency.

// LCD8B Timing Control Register 2
#define	LCD8TIM2			(*((volatile LCD8TIM2_REG *)(LCD8B_REG_BASE_ADDR + 0x06))).reg
#define	LCD8TIM2_NLINE		(*((volatile LCD8TIM2_REG *)(LCD8B_REG_BASE_ADDR + 0x06))).byte_reg[0]		///< These bits enable the n-line inverse AC drive function and set the number of inverse lines.
#define	LCD8TIM2_BSTC		(*((volatile LCD8TIM2_REG *)(LCD8B_REG_BASE_ADDR + 0x06))).byte_reg[1]		///< These bits select the booster clock frequency for the LCD voltage booster.

// LCD8B Power Control Register
#define	LCD8PWR				(*((volatile LCD8PWR_REG *)(LCD8B_REG_BASE_ADDR + 0x08))).reg
#define	LCD8PWR_VCEN		(*((volatile LCD8PWR_REG *)(LCD8B_REG_BASE_ADDR + 0x08))).bit.VCEN			///< This bit turns the LCD voltage regulator on and off.
#define	LCD8PWR_VCSEL		(*((volatile LCD8PWR_REG *)(LCD8B_REG_BASE_ADDR + 0x08))).bit.VCSEL			///< This bit sets the LCD voltage regulator output (reference voltage for boosting).
#define	LCD8PWR_HVLD		(*((volatile LCD8PWR_REG *)(LCD8B_REG_BASE_ADDR + 0x08))).bit.HVLD			///< This bit sets the LCD voltage regulator into heavy load protection mode.
#define	LCD8PWR_BSTEN		(*((volatile LCD8PWR_REG *)(LCD8B_REG_BASE_ADDR + 0x08))).bit.BSTEN			///< This bit turns the LCD voltage booster on and off.
#define	LCD8PWR_LC			(*((volatile LCD8PWR_REG *)(LCD8B_REG_BASE_ADDR + 0x08))).byte_reg[1]		///< These bits set the LCD panel contrast.

// LCD8B Display Control Register
#define	LCD8DSP				(*((volatile LCD8DSP_REG *)(LCD8B_REG_BASE_ADDR + 0x0A))).reg
#define	LCD8DSP_DSPC		(*((volatile LCD8DSP_REG *)(LCD8B_REG_BASE_ADDR + 0x0A))).bit.DSPC			///< These bits control the LCD display on/off and select a display mode.
#define	LCD8DSP_DSPAR		(*((volatile LCD8DSP_REG *)(LCD8B_REG_BASE_ADDR + 0x0A))).bit.DSPAR			///< This bit switches the display area in the display data RAM.
#define	LCD8DSP_DSPREV		(*((volatile LCD8DSP_REG *)(LCD8B_REG_BASE_ADDR + 0x0A))).bit.DSPREV		///< This bit controls black/white inversion on the LCD display.
#define	LCD8DSP_COMREV		(*((volatile LCD8DSP_REG *)(LCD8B_REG_BASE_ADDR + 0x0A))).bit.COMREV		///< This bit selects the common pin assignment direction.
#define	LCD8DSP_SEGREV		(*((volatile LCD8DSP_REG *)(LCD8B_REG_BASE_ADDR + 0x0A))).bit.SEGREV		///< This bit selects the segment pin assignment direction.

// LCD8B COM Pin Control Register 0
#define	LCD8COMC0			(*((volatile LCD8COMCX_REG *)(LCD8B_REG_BASE_ADDR + 0x0C))).reg
#define	LCD8COMC0_COM0DEN	(*((volatile LCD8COMCX_REG *)(LCD8B_REG_BASE_ADDR + 0x0C))).bit.COM0DEN		///< These bits configure the partial drive of the COM0 pin.
#define	LCD8COMC0_COM1DEN	(*((volatile LCD8COMCX_REG *)(LCD8B_REG_BASE_ADDR + 0x0C))).bit.COM1DEN		///< These bits configure the partial drive of the COM1 pin.
#define	LCD8COMC0_COM2DEN	(*((volatile LCD8COMCX_REG *)(LCD8B_REG_BASE_ADDR + 0x0C))).bit.COM2DEN		///< These bits configure the partial drive of the COM2 pin.
#define	LCD8COMC0_COM3DEN	(*((volatile LCD8COMCX_REG *)(LCD8B_REG_BASE_ADDR + 0x0C))).bit.COM3DEN		///< These bits configure the partial drive of the COM3 pin.
#define	LCD8COMC0_COM4DEN	(*((volatile LCD8COMCX_REG *)(LCD8B_REG_BASE_ADDR + 0x0C))).bit.COM4DEN		///< These bits configure the partial drive of the COM4 pin.
#define	LCD8COMC0_COM5DEN	(*((volatile LCD8COMCX_REG *)(LCD8B_REG_BASE_ADDR + 0x0C))).bit.COM5DEN		///< These bits configure the partial drive of the COM5 pin.
#define	LCD8COMC0_COM6DEN	(*((volatile LCD8COMCX_REG *)(LCD8B_REG_BASE_ADDR + 0x0C))).bit.COM6DEN		///< These bits configure the partial drive of the COM6 pin.
#define	LCD8COMC0_COM7DEN	(*((volatile LCD8COMCX_REG *)(LCD8B_REG_BASE_ADDR + 0x0C))).bit.COM7DEN		///< These bits configure the partial drive of the COM7 pin.

// LCD8B Interrupt Flag Register
#define	LCD8INTF			(*((volatile LCD8INTF_REG *)(LCD8B_REG_BASE_ADDR + 0x10))).reg
#define	LCD8INTF_FRMIF		LCD8INTF																	///< This bit indicates the frame interrupt cause occurrence status.

// LCD8B Interrupt Enable Register
#define	LCD8INTE			(*((volatile LCD8INTE_REG *)(LCD8B_REG_BASE_ADDR + 0x12))).reg
#define	LCD8INTE_FRMIE		LCD8INTE																	///< This bit enables the frame interrupt.
...
#define	RFC1CLK				(*((volatile RFCNCLK_REG *)(RFC_1_REG_BASE_ADDR + 0x00))).reg
#define	RFC1CLK_CLKSRC		(*((volatile RFCNCLK_REG *)(RFC_1_REG_BASE_ADDR + 0x00))).bit.CLKSRC		///< These bits select the clock source of the RFC.
#define	RFC1CLK_CLKDIV		(*((volatile RFCNCLK_REG *)(RFC_1_REG_BASE_ADDR + 0x00))).bit.CLKDIV		///< These bits select the division ratio of the RFC operating clock.
#define	RFC1CLK_DBRUN		(*((volatile RFCNCLK_REG *)(RFC_1_REG_BASE_ADDR + 0x00))).byte_reg[1]		///< This bit sets whether the RFC operating clock is supplied in DEBUG mode or not.

// RFC Ch.1 Control Register
#define	RFC1CTL				(*((volatile RFCNCTL_REG *)(RFC_1_REG_BASE_ADDR + 0x02))).reg
#define	RFC1CTL_MODEN		(*((volatile RFCNCTL_REG *)(RFC_1_REG_BASE_ADDR + 0x02))).bit.MODEN			///< This bit enables the RFC operations.
#define	RFC1CTL_SMODE		(*((volatile RFCNCTL_REG *)(RFC_1_REG_BASE_ADDR + 0x02))).bit.SMODE			///< These bits configure the oscillation mode.
#define	RFC1CTL_EVTEN		(*((volatile RFCNCTL_REG *)(RFC_1_REG_BASE_ADDR + 0x02))).bit.EVTEN			///< This bit enables external clock input mode (event counter mode).
#define	RFC1CTL_CONEN		(*((volatile RFCNCTL_REG *)(RFC_1_REG_BASE_ADDR + 0x02))).bit.CONEN			///< This bit disables the automatic CR oscillation stop function to enable continuous oscillation function.
#define	RFC1CTL_RFCLKMD		(*((volatile RFCNCTL_REG *)(RFC_1_REG_BASE_ADDR + 0x02))).byte_reg[1]		///< This bit sets the RFCLKOn pin to output the divided-by-two oscillation clock.

// RFC Ch.1 Oscillation Trigger Register
#define	RFC1TRG				(*((volatile RFCNTRG_REG *)(RFC_1_REG_BASE_ADDR + 0x04))).reg
#define	RFC1TRG_SREF		(*((volatile RFCNTRG_REG *)(RFC_1_REG_BASE_ADDR + 0x04))).bit.SREF			///< This bit controls CR oscillation for the reference resistor.
#define	RFC1TRG_SSENA		(*((volatile RFCNTRG_REG *)(RFC_1_REG_BASE_ADDR + 0x04))).bit.SSENA			///< This bit controls CR oscillation for sensor A.
#define	RFC1TRG_SSENB		(*((volatile RFCNTRG_REG *)(RFC_1_REG_BASE_ADDR + 0x04))).bit.SSENB			///< This bit controls CR oscillation for sensor B.

// RFC Ch.1 Measurement Counter Low Register
#define	RFC1MCL				(*((volatile RFCNMCL_REG *)(RFC_1_REG_BASE_ADDR + 0x06))).reg

// RFC Ch.1 Measurement Counter High Register
#define	RFC1MCH				(*((volatile RFCNMCH_REG *)(RFC_1_REG_BASE_ADDR + 0x08))).reg
#define	RFC1MCH_MC			(*((volatile RFCNMCH_REG *)(RFC_1_REG_BASE_ADDR + 0x08))).bit.MC			///< Measurement counter data can be read and written through these bits.

// RFC Ch.1 Measurement Counter Register
#define RFC1MC				(*((volatile RFCNMC_DWORD_REG *)(RFC_1_REG_BASE_ADDR + 0x06))).reg			///< Measurement counter data can be read and written through these bits.

// RFC Ch.1 Time Base Counter Low Register
#define	RFC1TCL				(*((volatile RFCNTCL_REG *)(RFC_1_REG_BASE_ADDR + 0x0A))).reg

// RFC Ch.1 Time Base Counter High Register
#define	RFC1TCH				(*((volatile RFCNTCH_REG *)(RFC_1_REG_BASE_ADDR + 0x0C))).reg
#define	RFC1TCH_TC			(*((volatile RFCNTCH_REG *)(RFC_1_REG_BASE_ADDR + 0x0C))).bit.TC			///< Time base counter data can be read and written through these bits.

// RFC Ch.1 Time Base Counter Register
#define RFC1TC				(*((volatile RFCNTC_DWORD_REG *)(RFC_1_REG_BASE_ADDR + 0x0A))).reg			///< Time base counter data can be read and written through these bits.

// RFC Ch.1 Interrupt Flag Register
#define	RFC1INTF			(*((volatile RFCNINTF_REG *)(RFC_1_REG_BASE_ADDR + 0x0E))).reg
#define	RFC1INTF_EREFIF		(*((volatile RFCNINTF_REG *)(RFC_1_REG_BASE_ADDR + 0x0E))).bit.EREFIF		///< This bit indicate Reference oscillation completion interrupt cause occurrence status.
#define	RFC1INTF_ESENAIF	(*((volatile RFCNINTF_REG *)(RFC_1_REG_BASE_ADDR + 0x0E))).bit.ESENAIF		///< This bit indicate Sensor B oscillation completion interrupt cause occurrence status.
#define	RFC1INTF_ESENBIF	(*((volatile RFCNINTF_REG *)(RFC_1_REG_BASE_ADDR + 0x0E))).bit.ESENBIF		///< This bit indicate Sensor B oscillation completion interrupt cause occurrence status.
#define	RFC1INTF_OVMCIF		(*((volatile RFCNINTF_REG *)(RFC_1_REG_BASE_ADDR + 0x0E))).bit.OVMCIF		///< This bit indicate Measurement counter overflow error interrupt cause occurrence status.
#define	RFC1INTF_OVTCIF		(*((volatile RFCNINTF_REG *)(RFC_1_REG_BASE_ADDR + 0x0E))).bit.OVTCIF		///< This bit indicate Time base counter overflow error interrupt cause occurrence status.

// RFC Ch.1 Interrupt Enable Register
#define	RFC1INTE			(*((volatile RFCNINTE_REG *)(RFC_1_REG_BASE_ADDR + 0x10))).reg
#define	RFC1INTE_EREFIE		(*((volatile RFCNINTE_REG *)(RFC_1_REG_BASE_ADDR + 0x10))).bit.EREFIE		///< This bit enable Reference oscillation completion interrupt.
#define	RFC1INTE_ESENAIE	(*((volatile RFCNINTE_REG *)(RFC_1_REG_BASE_ADDR + 0x10))).bit.ESENAIE		///< This bit enable Sensor A oscillation completion interrupt.
#define	RFC1INTE_ESENBIE	(*((volatile RFCNINTE_REG *)(RFC_1_REG_BASE_ADDR + 0x10))).bit.ESENBIE		///< This bit enable Sensor B oscillation completion interrupt.
#define	RFC1INTE_OVMCIE		(*((volatile RFCNINTE_REG *)(RFC_1_REG_BASE_ADDR + 0x10))).bit.OVMCIE		///< This bit enable Measurement counter overflow error interrupt.
#define	RFC1INTE_OVTCIE		(*((volatile RFCNINTE_REG *)(RFC_1_REG_BASE_ADDR + 0x10))).bit.OVTCIE		///< This bit enable Time base counter overflow error interrupt.
...
#define ADC12_0CTL				(*((volatile ADC12_NCTL_REG *)(ADC12A_0_REG_BASE_ADDR + 0x00))).reg
#define ADC12_0CTL_MODEN		(*((volatile ADC12_NCTL_REG *)(ADC12A_0_REG_BASE_ADDR + 0x00))).bit.MODEN		///< This bit enables the ADC12A operations.
#define ADC12_0CTL_ADST 		(*((volatile ADC12_NCTL_REG *)(ADC12A_0_REG_BASE_ADDR + 0x00))).bit.ADST		///< This bit starts A/D conversion or enables to accept triggers.
#define ADC12_0CTL_BSYSTAT		(*((volatile ADC12_NCTL_REG *)(ADC12A_0_REG_BASE_ADDR + 0x00))).bit.BSYSTAT 	///< This bit indicates whether the ADC12A is executing A/D conversion or not.
#define ADC12_0CTL_ADSTAT		(*((volatile ADC12_NCTL_REG *)(ADC12A_0_REG_BASE_ADDR + 0x00))).bit.ADSTAT		///< These bits indicate the analog input pin number m being A/D converted.

// ADC12A Ch.0 Trigger/Analog Input Select Register
#define ADC12_0TRG				(*((volatile ADC12_NTRG_REG *)(ADC12A_0_REG_BASE_ADDR + 0x02))).reg
#define ADC12_0TRG_SMPCLK		(*((volatile ADC12_NTRG_REG *)(ADC12A_0_REG_BASE_ADDR + 0x02))).bit.SMPCLK		///< These bits set the analog input signal sampling time.
#define ADC12_0TRG_CNVTRG		(*((volatile ADC12_NTRG_REG *)(ADC12A_0_REG_BASE_ADDR + 0x02))).bit.CNVTRG		///< These bits select a trigger source to start A/D conversion.
#define ADC12_0TRG_CNVMD		(*((volatile ADC12_NTRG_REG *)(ADC12A_0_REG_BASE_ADDR + 0x02))).bit.CNVMD		///< This bit sets the A/D conversion mode.
#define ADC12_0TRG_STMD 		(*((volatile ADC12_NTRG_REG *)(ADC12A_0_REG_BASE_ADDR + 0x02))).bit.STMD		///< This bit selects the data alignment when the conversion results are loaded into the A/D conversion result registers.
#define ADC12_0TRG_STAAIN		(*((volatile ADC12_NTRG_REG *)(ADC12A_0_REG_BASE_ADDR + 0x02))).bit.STAAIN		///< These bits set the analog input pin to be A/D converted first.
#define ADC12_0TRG_ENDAIN		(*((volatile ADC12_NTRG_REG *)(ADC12A_0_REG_BASE_ADDR + 0x02))).bit.ENDAIN		///< These bits set the analog input pin to be A/D converted last.

// ADC12A Ch.n0 Configuration Register
#define ADC12_0CFG				(*((volatile ADC12_NCFG_REG *)(ADC12A_0_REG_BASE_ADDR + 0x04))).reg
#define ADC12_0CFG_VRANGE		ADC12_0CFG 																		///< These bits set the A/D converter operating voltage range.

// ADC12A Ch.0 Interrupt Flag Register
#define ADC12_0INTF 			(*((volatile ADC12_NINTF_REG *)(ADC12A_0_REG_BASE_ADDR + 0x06))).reg
#define ADC12_0INTF_AD0CIF		(*((volatile ADC12_NINTF_REG *)(ADC12A_0_REG_BASE_ADDR + 0x06))).bit.AD0CIF 	///< This bit indicate Analog input signal 0 A/D conversion completion interrupt cause occurrence status.
#define ADC12_0INTF_AD1CIF		(*((volatile ADC12_NINTF_REG *)(ADC12A_0_REG_BASE_ADDR + 0x06))).bit.AD1CIF 	///< This bit indicate Analog input signal 1 A/D conversion completion interrupt cause occurrence status.
#define ADC12_0INTF_AD2CIF		(*((volatile ADC12_NINTF_REG *)(ADC12A_0_REG_BASE_ADDR + 0x06))).bit.AD2CIF 	///< This bit indicate Analog input signal 2 A/D conversion completion interrupt cause occurrence status.
#define ADC12_0INTF_AD3CIF		(*((volatile ADC12_NINTF_REG *)(ADC12A_0_REG_BASE_ADDR + 0x06))).bit.AD3CIF 	///< This bit indicate Analog input signal 3 A/D conversion completion interrupt cause occurrence status.
#define ADC12_0INTF_AD0OVIF 	(*((volatile ADC12_NINTF_REG *)(ADC12A_0_REG_BASE_ADDR + 0x06))).bit.AD0OVIF	///< This bit indicate Analog input signal 0 A/D conversion result overwrite error interrupt cause occurrence status.
#define ADC12_0INTF_AD1OVIF 	(*((volatile ADC12_NINTF_REG *)(ADC12A_0_REG_BASE_ADDR + 0x06))).bit.AD1OVIF	///< This bit indicate Analog input signal 1 A/D conversion result overwrite error interrupt cause occurrence status.
#define ADC12_0INTF_AD2OVIF 	(*((volatile ADC12_NINTF_REG *)(ADC12A_0_REG_BASE_ADDR + 0x06))).bit.AD2OVIF	///< This bit indicate Analog input signal 2 A/D conversion result overwrite error interrupt cause occurrence status.
#define ADC12_0INTF_AD3OVIF 	(*((volatile ADC12_NINTF_REG *)(ADC12A_0_REG_BASE_ADDR + 0x06))).bit.AD3OVIF	///< This bit indicate Analog input signal 3 A/D conversion result overwrite error interrupt cause occurrence status.

// ADC12A Ch.0 Interrupt Enable Register
#define ADC12_0INTE 			(*((volatile ADC12_NINTE_REG *)(ADC12A_0_REG_BASE_ADDR + 0x08))).reg
#define ADC12_0INTE_AD0CIE		(*((volatile ADC12_NINTE_REG *)(ADC12A_0_REG_BASE_ADDR + 0x08))).bit.AD0CIE 	///< This bit enable Analog input signal 0 A/D conversion completion interrupt.
#define ADC12_0INTE_AD1CIE		(*((volatile ADC12_NINTE_REG *)(ADC12A_0_REG_BASE_ADDR + 0x08))).bit.AD1CIE 	///< This bit enable Analog input signal 1 A/D conversion completion interrupt.
#define ADC12_0INTE_AD2CIE		(*((volatile ADC12_NINTE_REG *)(ADC12A_0_REG_BASE_ADDR + 0x08))).bit.AD2CIE 	///< This bit enable Analog input signal 2 A/D conversion completion interrupt.
#define ADC12_0INTE_AD3CIE		(*((volatile ADC12_NINTE_REG *)(ADC12A_0_REG_BASE_ADDR + 0x08))).bit.AD3CIE 	///< This bit enable Analog input signal 3 A/D conversion completion interrupt.
#define ADC12_0INTE_AD0OVIE 	(*((volatile ADC12_NINTE_REG *)(ADC12A_0_REG_BASE_ADDR + 0x08))).bit.AD0OVIE	///< This bit enable Analog input signal 0 A/D conversion result overwrite error interrupt.
#define ADC12_0INTE_AD1OVIE 	(*((volatile ADC12_NINTE_REG *)(ADC12A_0_REG_BASE_ADDR + 0x08))).bit.AD1OVIE	///< This bit enable Analog input signal 1 A/D conversion result overwrite error interrupt.
#define ADC12_0INTE_AD2OVIE 	(*((volatile ADC12_NINTE_REG *)(ADC12A_0_REG_BASE_ADDR + 0x08))).bit.AD2OVIE	///< This bit enable Analog input signal 2 A/D conversion result overwrite error interrupt.
#define ADC12_0INTE_AD3OVIE 	(*((volatile ADC12_NINTE_REG *)(ADC12A_0_REG_BASE_ADDR + 0x08))).bit.AD3OVIE	///< This bit enable Analog input signal 3 A/D conversion result overwrite error interrupt.

// ADC12A Ch.0 Result Register 0
#define ADC12_0AD0D 			(*((volatile ADC12_NADMD_REG *)(ADC12A_0_REG_BASE_ADDR + 0x0a))).reg			///< These bits are the A/D conversion results of the analog input signal 0.

// ADC12A Ch.0 Result Register 1
#define ADC12_0AD1D 			(*((volatile ADC12_NADMD_REG *)(ADC12A_0_REG_BASE_ADDR + 0x0c))).reg			///< These bits are the A/D conversion results of the analog input signal 1.

// ADC12A Ch.0 Result Register 2
#define ADC12_0AD2D 			(*((volatile ADC12_NADMD_REG *)(ADC12A_0_REG_BASE_ADDR + 0x0e))).reg			///< These bits are the A/D conversion results of the analog input signal 2.

// ADC12A Ch.0 Result Register 3
#define ADC12_0AD3D 			(*((volatile ADC12_NADMD_REG *)(ADC12A_0_REG_BASE_ADDR + 0x10))).reg			///< These bits are the A/D conversion results of the analog input signal 3.
